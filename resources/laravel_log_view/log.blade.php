...
<head>
    ...
    <link rel="stylesheet"
          href="{{admin_asset("vendor/laravel-log/css/bootstrap.min.css")}}">
    <link rel="stylesheet" type="text/css"
          href="{{admin_asset("vendor/laravel-log/css/dataTables.bootstrap4.min.css")}}">
    ...
    <div class="row">
        <div class="col sidebar mb-3">
            ...
            <div class="custom-control custom-switch" style="padding-bottom:20px;">
                ...
                <label class="custom-control-label" for="darkSwitch" style="margin-top: 6px;">Dark
                    Mode</label>
            </div>
            ...
            <div class="list-group div-scroll">
                @foreach($folders as $folder)
                    <div class="list-group-item">
                        <?php
                        \Rap2hpoutre\LaravelLogViewer\LaravelLogViewer::DirectoryTreeStructure($storage_path,
                            $structure);
                        ?>
...
<script src="{{admin_asset("vendor/laravel-log/js/jquery-3.2.1.slim.min.js")}}"></script>
<script src="{{admin_asset("vendor/laravel-log/js/bootstrap.min.js")}}"></script>
<!-- FontAwesome -->
<script defer src="{{admin_asset("vendor/laravel-log/js/all.js")}}"></script>

<!-- Datatables -->
<script defer src="{{admin_asset("vendor/laravel-log/js/jquery.dataTables.min.js")}}"></script>

<script defer src="{{admin_asset("vendor/laravel-log/js/dataTables.bootstrap4.min.js")}}"></script>
